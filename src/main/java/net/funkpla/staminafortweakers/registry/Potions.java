...
public class Potions {
    ...
    public static final Holder<Potion> FATIGUE_POTION = registerPotion(StaminaMod.locate("fatigue_potion"), new FatiguePotion(3600, 2));
    public static final Holder<Potion> LONG_FATIGUE_POTION = registerPotion(StaminaMod.locate("long_fatigue_potion"), new FatiguePotion(9600, 2));
    public static final Holder<Potion> TIRELESSNESS_POTION = registerPotion(StaminaMod.locate("tirelessness_potion"), new TirelessnessPotion(3600));
    public static final Holder<Potion> LONG_TIRELESSNESS_POTION = registerPotion(StaminaMod.locate("long_tirelessness_potion"), new TirelessnessPotion(9600));
