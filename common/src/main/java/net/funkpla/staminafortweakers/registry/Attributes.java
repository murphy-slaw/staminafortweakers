...
public class Attributes {
    ...
    private static Attribute registerAttribute(final String name, double base, double min, double max) {
        Attribute attribute = new RangedAttribute("attribute.name." + StaminaConstants.MOD_ID + '.' + name, base, min, max).setSyncable(true);
        return Registry.register(BuiltInRegistries.ATTRIBUTE, new ResourceLocation(StaminaConstants.MOD_ID, name), attribute);
    }
