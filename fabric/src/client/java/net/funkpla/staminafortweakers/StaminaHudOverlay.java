...
public class StaminaHudOverlay implements HudRenderCallback {
    ...
    private void renderStaminaIcon(GuiGraphics context, @NotNull LocalPlayer player, double scale, int height,
        ...
        if (player.isSprinting()) {
            icon = StaminaCommon.locate("textures/stamina/sprint.png");
            bgIcon = StaminaCommon.locate("textures/stamina/sprint_background.png");
        } else {
            icon = StaminaCommon.locate("textures/stamina/walk.png");
            bgIcon = StaminaCommon.locate("textures/stamina/walk_background.png");
        }
