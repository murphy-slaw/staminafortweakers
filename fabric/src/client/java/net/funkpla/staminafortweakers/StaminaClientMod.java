...
public class StaminaClientMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        icons.add(StaminaCommon.locate("textures/stamina/walk.png"));
        icons.add(StaminaCommon.locate("textures/stamina/sprint.png"));

        ResourceManagerHelper.get(PackType.CLIENT_RESOURCES).registerReloadListener(new SimpleSynchronousResourceReloadListener() {
            @Override
            public ResourceLocation getFabricId() {
                return new ResourceLocation(StaminaConstants.MOD_ID, "resources");
            }
